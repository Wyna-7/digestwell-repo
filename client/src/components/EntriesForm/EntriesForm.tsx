...
function EntriesForm() {
  ...
  const handleChange = (event: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement> | SelectChangeEvent<string | EventTarget>) => {
  ...
  return (
    <Paper className='form-container' elevation={10}>
      <Box className='form-box' component='form' onSubmit={handleSubmit}>
        <TextField className='form-field' type='text' name='item' value={formData.item} onChange={handleChange} placeholder='What did you consume?' variant='outlined' margin='normal' />
        <FormControl className='form-field' variant='outlined' margin='normal'>
          <InputLabel>Select an option</InputLabel>
          <Select name='selectedOption' value={formData.selectedOption} onChange={handleChange} label='Select an option'>
        ...
        <TextField className='form-field' type='text' name='otherSymptoms' value={formData.otherSymptoms} onChange={handleChange} placeholder='What are your symptoms?' variant='outlined' margin='normal' />
        <FormControl className='form-field' variant='outlined' margin='normal'>
          <InputLabel>Bristol Stool Scale</InputLabel>
          <Select name='selectedStoolType' value={formData.selectedStoolType} onChange={handleChange} label='Bristol Stool Scale'>
        ...
        {formData.selectedStoolType && (
          <FormGroup>
            <FormControlLabel control={<Checkbox value={formData.bloodInStool} onChange={handleChange} name='bloodInStool' />} label='Blood in Stool' />
          </FormGroup>
        )}
        <Button
          className='add-btn'
